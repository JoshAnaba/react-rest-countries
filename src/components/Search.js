...
const Search = ({search, searchCountry}) => {
  return (
    <>
      <div className="search-bar flex items-center gap-5 md:w-1/2 w-full shadow-md p-3.5 rounded-md transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
