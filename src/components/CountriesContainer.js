    ...
    <div className='pt-16 pb-16 pr-20 pl-20 flex flex-col gap-10'>
     <div className='z-10 h-10 top flex items-center justify-between'>
      <div className="search-bar flex items-center gap-5 shadow-md p-3.5 rounded-md transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
          ...
          <input type="search" id="search" placeholder='Search country' className='border-0 outline-0 w-96' />
        </div>
      <div>
        <div className="filters relative cursor-pointer items-center w-44">
          <button className='flex items-center gap-5 min-w-full justify-between transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 shadow-md p-3.5 rounded-md'>
            <span className="">{region? region : 'Filter by Region'}</span>
            <span className="material-icons">expand_more</span>
          </button>
          <div className='filter-item-ctn flex flex-col absolute top-14 shadow-md rounded-md w-full right-0 left-0 bg-white p-2'>
